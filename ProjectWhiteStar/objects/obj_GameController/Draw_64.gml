    ...
    for (var i = 0; i < array_length(map_buttons); i++)
    {
        ...
        else
        {
            ...
            switch (b.name)
            {
                ...
                case "dining":  button_color = c_ltgrey break;
                default:        button_color = c_white; break;
            }
        }

        draw_sprite_ext(button_sprite, 0, bx, by, button_scale, button_scale, 0, button_color, 1);
    }
}
